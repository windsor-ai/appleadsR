...
## Analyzing our Apple Search  and Apple Search ad campaign data 

Now we can analyze our Apple Search Ads data. For instance, let's compare the two campaigns we have to see which one performed better the last 100 days. 
